...
misty.Pause(3000);
misty.ChangeLED(100,0,250,0,100); //Change to default Misty purple
misty.Pause(3000);
...
function playDanceMove(danceMove){
    ...
    switch (danceMove){
        ...
        case "groovy":
            ...
            misty.ChangeLED(100,0,250,0,100);
            ...
            for (var i = 1; i <= 2; i=i+1){
                ...
                misty.MoveHead(10, 35, -10, 70, 50, 50); //Move head - groovy position 1               
                misty.MoveArm("right", 90, 100, 0, 50, 50); 
                misty.MoveArm("left", -28, 100, 0, 50, 50); 
                misty.DriveTime(5,5,1000); //Drive forward a little
                misty.Pause(groovyPause);

                misty.MoveHead(14, -27, -10, 70, 50, 50); //Move head - groovy position 2
                misty.MoveArm("right", -28, 100, 0, 50, 50);  
                misty.MoveArm("left", 90, 100, 0, 50, 50); 
                misty.DriveTime(-5,-5,1000);
                misty.Pause(groovyPause);
                
                misty.MoveHead(-13, -32, -2, 70, 50, 50); //Move head - groovy position 3
                misty.MoveArm("right", 90, 100, 0, 50, 50); 
                misty.MoveArm("left", -28, 100, 0, 50, 50); 
                misty.DriveTime(10,10,1000);
                misty.Pause(groovyPause);
                
                misty.MoveHead(-15, 35, -13, 70, 50, 50); //Move head - groovy position 4     
                misty.MoveArm("right", -28, 100, 0, 50, 50);     
                misty.MoveArm("left", 90, 100, 0, 50, 50);     
                misty.DriveTime(-10,-10,1000);
                misty.Pause(groovyPause);
